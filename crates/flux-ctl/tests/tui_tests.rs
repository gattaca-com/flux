    ...
    let groups = vec![AppGroup {
        ...
        segments: vec![
            SegmentInfo {
                ...
                alive: true,
                pid_count: 1,
                queue_writes: Some(42), queue_fill: None, queue_capacity: None, poison: None, msgs_per_sec: None,
            },
            SegmentInfo {
                entry: data_entry("myapp", "Config", "/dev/shm/d1", 128),
                alive: true,
                pid_count: 1,
                queue_writes: None, queue_fill: None, queue_capacity: None, poison: None, msgs_per_sec: None,
            },
        ],
        expanded: true,
    }];
...
fn multi_pid_renders_count() {
    ...
    let groups = vec![AppGroup {
        ...
        segments: vec![SegmentInfo {
            ...
            alive: true,
            pid_count: 3,
            queue_writes: Some(100), queue_fill: None, queue_capacity: None, poison: None, msgs_per_sec: None,
        }],
        expanded: true,
    }];
