...
/// Transport-agnostic connector. Re-exported here under the old name so
/// existing `flux_network::tcp::TcpConnector` users keep compiling.
pub use crate::connector::{Connector as TcpConnector, PollEvent, SendBehavior, Transport};
